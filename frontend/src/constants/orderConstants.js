...
export const ORDER_LIST_REQUEST = "ORDER_HISTORY_REQUEST";
export const ORDER_LIST_SUCCESS = "ORDER_HISTORY_SUCCESS";
export const ORDER_LIST_FAIL = "ORDER_HISTORY_FAIL";
